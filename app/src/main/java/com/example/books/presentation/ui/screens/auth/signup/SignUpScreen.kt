...
import com.example.books.presentation.ui.screens.auth.login.LoginViewModel

@Composable
fun SignUpScreen(navController: NavHostController, rootNavController: NavHostController, signupViewModel: SignupViewModel = hiltViewModel()) {
    ...
    Surface(
        ...
        if(signupViewModel.signupState.value.isLoading){
        ...
        Column(
            ...
            Column(
                ...
                OutlinedTextField(
                    isError = signupViewModel.signupState.value.error != "",
                    shape = RoundedCornerShape(10.dp),
                    maxLines = 1,
                    label = { Text("Name", fontFamily = FontFamily(Font(R.font.my_custom_font_medium))) },
                ...
                Button(
                    ...
                    modifier = Modifier
                        ...
                        .padding(start = 16.dp, end = 16.dp, bottom = 16.dp),
                    onClick = {
                        signupViewModel.signup(nameValue, loginValue, passwordValue)
                    }
                ) {
                    Text(text = "SIGN UP")
                }
                if (signupViewModel.signupState.value.signupResponse.email != ""){
                    navController.navigate(route = AuthScreens.LOGIN.name)
